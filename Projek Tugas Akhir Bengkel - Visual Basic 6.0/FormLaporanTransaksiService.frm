...
Begin VB.Form FormLaporanTransaksiService 
   BackColor       =   &H00808000&
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Label Label2 
         BackColor       =   &H00808000&
         Caption         =   "SEMUA TRANSAKSI SERVICE :"
         BeginProperty Font 
            Name            =   "Times New Roman"
            Size            =   12
            Charset         =   0
   ...
   Begin Crystal.CrystalReport CrystalReport2 
      ...
      _ExtentY        =   741
      _Version        =   348160
      ReportFileName  =   "C:\Users\ACER AspireOne Z1402\Documents\PEMROGRAMAN JARINGAN\LAPORAN BENGKEL\LAPORAN TRANSAKSI SERVICE.rpt"
   ...
   End
End
Attribute VB_Name = "FormLaporanTransaksiService"
...
tanggal = "{tb_service.tanggal}in date" + "('" & Format(DTPicker1, "mm-dd-yyyy") & "')to date" + "('" & Format(DTPicker2, "mm-dd-yyyy") & "')"
